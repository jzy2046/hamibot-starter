...
var BaseException = function () {
  function BaseException(message) {
    ...
    var trace = getStackTrace().filter(this.traceFilter);
    this.traceBack = trace.toString(this.traceFormatter);
    EVENT.emit("ERROR", this);
  }

  BaseException.prototype.traceFilter = function (frame, index, array) {
    return true;
  };

  BaseException.prototype.traceFormatter = function (line, callerName) {
    return "  | at line ".concat(line, ", in <").concat(callerName, ">");
  };
